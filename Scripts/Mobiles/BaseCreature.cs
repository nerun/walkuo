...
namespace Server.Mobiles
{
	...
	public partial class BaseCreature : Mobile, IHonorTarget, IQuestGiver
	{
		...
		*/
		...
		originally it taken out of WalkUO, and not implmented on OSIs production shards until more 
		...
		*/
		...
		/* To save on cpu usage, WalkUO creatures only reacquire creatures under the following circumstances:
